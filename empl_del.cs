...
{
    public partial class empl_del : Form
    {
        ...
        private void empl_del_Load(object sender, EventArgs e)
        {
            string querystring = "select email from employee where id != 1";
